# -*- coding: utf-8 -*-
"""Despliegue - Inversion para videojuegos.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AjANPdHt99l2gDChvopePBJr1sBqioNp
...
#Valida que exista solamente estas variables en el conjunto de datos
...
"""# Predicciones
*   El modelo no presentaba error


"""

#Hacemos la predicción con el modelo seleccionado
